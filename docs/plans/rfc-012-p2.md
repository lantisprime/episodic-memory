...
| Existing suites stay green | `node tests/test-em-promote.mjs` (and CI via `gh pr checks`) | S3 local: promotion-sources 20/20, store-identity 27/27, plugin-registry 205/205, p0-schemas 126/126, uninstall-activation 26/26, ci-suite-registration 16/16 (2026-07-19); CI _pending_ |
...
| Deploys clean | `node tools/deploy-audit.mjs` (unfiltered) | _pending_ (post-merge drill) |
