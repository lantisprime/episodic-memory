...
| **P5–P7** | [P5-P7-tool-plugins.md](P5-P7-tool-plugins.md) | R6, R10 | P3 | **P5 DONE** (OpenCode plugin #424 `f5dbaef`, doc fix #425); **P6 IN PROGRESS** (Codex enforcement plugin; plan codex-ACCEPTED 2026-06-28, MEDIUM-honest tier; implementing S0+); **P7 queued** (Pi Agent) |
