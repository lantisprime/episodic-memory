...
| **P4** | [P4-enforce-config.md](P4-enforce-config.md) | R3, R5 | P3 | **IN PROGRESS** — schema P3b-2 #393 + P4a #397 (per-project loader → 3 pre_tool_use gates) + P4c #398 (layer-wide `active:false` kill switch) DONE; P4b reduced E2E + cutover remains |
