// mini-jsonschema.mjs — TEST-ONLY JSON-Schema 2020-12 keyword-grammar linter.
//
// RFC-008 P0 validity-verification gate (v11.8). This is NOT a meta-schema
// interpreter — it never loads the official 2020-12 meta-schema and never
// resolves $dynamicRef / $dynamicAnchor (replicating that machinery is the most
// error-prone corner of the spec and the wrong patch class — see the R0b plan
// review, rounds 2-3). It directly asserts that a document conforms to the
// 2020-12 keyword grammar, recursing into every subschema-bearing position.
//
...
//
// T17: test-only `.mjs` under tests/ — NOT a shipped runtime/CI validator. Full
// official-meta-schema validation is owned by P2's scripts/validate-schemas.mjs.
