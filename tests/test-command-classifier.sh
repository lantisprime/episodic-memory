...
echo ""
echo "--- #471: tracker-metadata gh writes are NOT push_or_pr_create ---"
assert_label "T25 gh issue create" "gh issue create --title x --body y" "nonsrc_write"
assert_label "T26 gh issue close" "gh issue close 5" "nonsrc_write"
assert_label "#471-01 gh issue comment" "gh issue comment 1 --body y" "nonsrc_write"
assert_label "#471-02 gh issue edit" "gh issue edit 1 --add-label bug" "nonsrc_write"
assert_label "#471-03 gh label create" "gh label create bug --color ff0000" "nonsrc_write"
assert_label "#471-04 gh -R o/r issue create" "gh -R o/r issue create --title x" "nonsrc_write"
assert_label "#471-05 env-prefixed gh issue create" "FOO=1 gh issue create --title x" "nonsrc_write"
assert_label "#471-06 gh label list stays read_only" "gh label list" "read_only"
# Push-class must survive the narrowing, including env-prefixed / chained forms
# and a push chained after an issue write (chain max keeps push).
assert_label "#471-07 git push still push" "git push origin main" "push_or_pr_create"
assert_label "#471-08 gh pr create still push" "gh pr create --title x --body y" "push_or_pr_create"
assert_label "#471-09 gh pr merge still push" "gh pr merge 1" "push_or_pr_create"
assert_label "#471-10 env-prefixed gh pr create" "FOO=1 gh pr create --title x" "push_or_pr_create"
assert_label "#471-11 cd && gh pr create" "cd x && gh pr create --title x" "push_or_pr_create"
assert_label "#471-12 gh issue create && git push" "gh issue create --title x && git push" "push_or_pr_create"
assert_label "#471-13 git push; gh issue comment" "git push; gh issue comment 1 --body y" "push_or_pr_create"
assert_label "#471-14 gh release create still push" "gh release create v1" "push_or_pr_create"
assert_label "#471-15 gh repo sync still push" "gh repo sync" "push_or_pr_create"
